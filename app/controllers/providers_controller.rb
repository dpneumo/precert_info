class ProvidersController < ApplicationController
  ...
  def index
    @pagy, @providers = pagy(Provider.order(:last_name, :first_name).includes(:office), items: 12)
  end
  ...
  private
    ...
    def provider_params
      params.require(:provider).permit(:first_name, :last_name, :credentials, :office_id)
    end
end
