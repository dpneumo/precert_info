module SeedBag
  def self.prod_seeds
    ...
    Provider.find_or_create_by!(first_name: 'Mitch',           last_name: 'Kuppinger',     credentials: 'MD',             office_id: off2.id)
    Provider.find_or_create_by!(first_name: 'John',            last_name: 'Burk',          credentials: 'MD',             office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'John',            last_name: 'Hollingsworth', credentials: 'MD',             office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Ariffin',         last_name: 'Alam',          credentials: 'MD',             office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Jonathan',        last_name: 'Besas',         credentials: 'DO',             office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Robert L',        last_name: 'Cash Jr',       credentials: 'MD',             office_id: off3.id)
    Provider.find_or_create_by!(first_name: 'Kevin G ',        last_name: 'Connelly',      credentials: 'MD',             office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Huy X',           last_name: 'Duong',         credentials: 'DO',             office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Sai Karan Vamsi', last_name: 'Guda',          credentials: 'DO',             office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Abigale D ',      last_name: 'Henry',         credentials: 'MD',             office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Stuart D ',       last_name: 'McDonald',      credentials: 'MD',             office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Andrew L',        last_name: 'Miller',        credentials: 'MD',             office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Kerim F',         last_name: 'Razack',        credentials: 'MD',             office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Muhammad Hasham', last_name: 'Sarwar',        credentials: 'MD',             office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'James T',         last_name: 'Siminski',      credentials: 'MD',             office_id: off3.id)
    Provider.find_or_create_by!(first_name: 'Amy',             last_name: 'Tounget',       credentials: 'AGACNP-BC',      office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Brandi R',        last_name: 'Trujillo',      credentials: 'AGACNP-BC',      office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Amanda',          last_name: 'Viehmann',      credentials: 'FNP, AGACNP-BC', office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Kelli R',         last_name: 'Vogler',        credentials: 'PA-C',           office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Kathleen',        last_name: 'Wilhite',       credentials: 'PA-C',           office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Amy M.',          last_name: 'Bird',          credentials: 'ACNP-BC',        office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Katherine',       last_name: 'Blalock',       credentials: 'AGACNP-BC',      office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Victoria',        last_name: 'Brothers',      credentials: 'PA-C',           office_id: off3.id)
    Provider.find_or_create_by!(first_name: 'Kenneth',         last_name: 'Collins',       credentials: 'AGACNP-BC',      office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'John',            last_name: 'Deetjen',       credentials: 'PA-C',           office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Kimberly',        last_name: 'Grady',         credentials: 'ACNPC-AG',       office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Jonathan L',      last_name: 'Ives',          credentials: 'PA-C',           office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Dustin',          last_name: 'Kunz',          credentials: 'PA',             office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Pedro A',         last_name: 'Mendoza',       credentials: 'DNP, AGACNP-BC', office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Marcella I',      last_name: 'Miller',        credentials: 'FNP',            office_id: off3.id)
    Provider.find_or_create_by!(first_name: 'K Corinne',       last_name: 'Moreland',      credentials: 'ANP-BC',         office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Angela D',        last_name: 'Naser-Duong',   credentials: 'ACNP-BC',        office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Cynthia M',       last_name: 'Roger',         credentials: 'ACNP-BC',        office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Erin',            last_name: 'Rutledge',      credentials: 'PA-C',           office_id: off1.id)
    Provider.find_or_create_by!(first_name: 'Sarah',           last_name: 'Shaffer',       credentials: 'PA-C',           office_id: off1.id)
